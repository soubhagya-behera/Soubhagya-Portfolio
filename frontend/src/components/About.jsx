...
function About() {
  return (
    <section id="about" className="section-shell !py-[4.5rem] lg:!py-[5.5rem]">
      <SectionHeading eyebrow="About" title="Focused on building practical full-stack skills">
  ...
  I am an MCA student at USBM focused on Java Full Stack Development and modern backend engineering.

  <br /><br />

  I enjoy building scalable applications using Spring Boot, REST APIs, MySQL and React while improving through real-world projects and practical problem solving.
</p>
